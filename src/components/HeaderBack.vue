...
<template>
  <div class="bar">
    <span class="icon-box" v-on:click="back">
    ...
    <Transition>
      <span class="icon-box">
        <svg v-show="props.loading" class="icon loading" viewBox="0 0 1024 1024" version="1.1"
          ...
          <path
            ...
            fill="#000000" fill-opacity=".05" p-id="2664"></path>
          <path
